...
<div class="col-outer {if isset($smarty.cookies.view) and $smarty.cookies.view == 'list'}col-12{else}{$col_class} grid-item p-1 m-0{/if}" data-grid-classes="{$col_class}">
    <div class="card card-thumbnail {if isset($thumbnail.path_ext)}path-ext-{$thumbnail.path_ext}{/if} {if isset($thumbnail.file_ext)}file-ext-{$thumbnail.file_ext}{/if}" {if isset($smarty.cookies.view) and $smarty.cookies.view != 'list'}style="border: 0px;"{/if}>
      <div class="h-100">
